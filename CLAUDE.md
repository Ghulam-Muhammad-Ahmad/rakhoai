...
The app is now initialized with Next.js, Supabase Auth/DB, upload parsing, column mapping, risk scoring foundations, and dashboard routes.
...
Do not use Prisma commands. Prisma has been removed from the app architecture.
