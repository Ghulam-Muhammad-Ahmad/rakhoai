...
function FieldShell({
  ...
  return (
    <label className="flex min-w-0 flex-col gap-1.5">
      ...
      <span className="flex min-w-0 items-center gap-2.5 rounded-[var(--radius-md)] border border-[var(--neutral-200)] bg-white px-3.5 py-2.5 transition-colors focus-within:border-[var(--primary-400)] focus-within:ring-2 focus-within:ring-[var(--primary-400)]/20">
