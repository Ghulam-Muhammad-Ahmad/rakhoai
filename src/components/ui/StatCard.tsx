  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: "var(--radius-lg)", padding: "clamp(14px, 4vw, 20px)",
      ...
      <div style={{
        fontFamily: "var(--font-display)", fontWeight: 500, fontSize: "clamp(26px, 7vw, 36px)",
        lineHeight: 1, letterSpacing: "-0.02em", overflowWrap: "anywhere",
