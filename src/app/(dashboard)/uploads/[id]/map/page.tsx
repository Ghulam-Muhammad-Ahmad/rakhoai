...
export default async function MapPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="page-fade">
      ...
      <div style={{ maxWidth: 960, margin: "18px auto 20px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12, padding: 16, border: "1px solid var(--neutral-200)", borderRadius: 10, background: "#fff" }}>
        <div>
